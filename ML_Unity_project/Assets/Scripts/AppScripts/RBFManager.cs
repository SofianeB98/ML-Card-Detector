...
public class RBFManager : MonoBehaviour
{
    private static RBFManager instance;
    public static RBFManager Instance => RBFManager.instance;
    ...
    public void CreateModel()
    {
        ...
        //On crée notre model
        MLParameters.model = MLDLLWrapper.CreateRBFModel(MLParameters.k, MLParameters.Alpha);
        MLParameters.Output_size = TextureLoader.Instance.foldersName.Length;
    ...
    public void TrainModel()
    {
        ...
        for (int tr = 0; tr < MLParameters.TrainLoopCount; tr++)
        {
            ...
            MLDLLWrapper.TrainRBFModel(MLParameters.model, inputs_dataset, MLParameters.Input_size, MLParameters.SampleCounts, outputs, MLParameters.Output_size);
    ...
    public void DeleteModel()
    {
        ...
        MLDLLWrapper.DeleteRBFModel(MLParameters.model);
